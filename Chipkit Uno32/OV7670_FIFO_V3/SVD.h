...
{
   double det;
   det=Matriz[1][1]*Matriz[2][2]*Matriz[3][3] + Matriz[1][2]*Matriz[2][3]*Matriz[3][1] + Matriz[1][3]*Matriz[2][1]*Matriz[3][2] - (Matriz[1][3]*Matriz[2][2]*Matriz[3][1] + Matriz[2][3]*Matriz[3][2]*Matriz[1][1] + Matriz[3][3]*Matriz[1][2]*Matriz[2][1]);
   return det;
